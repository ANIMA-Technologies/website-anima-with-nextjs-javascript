            ...
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className={`dropdown-menu ${styles.dropdown1}`} aria-labelledby="navbarDropdown">
                  <li><a className={`dropdown-item ${styles.dropdownItem} ${styles.dropdownItem0}`} href="#">Développement web</a></li>
                  <li><a className={`dropdown-item ${styles.dropdownItem} ${styles.dropdownItem0}`} href="#">Développement MOBILE</a></li>
                  <li><a className={`dropdown-item ${styles.dropdownItem} ${styles.dropdownItem0}`}>Développement de logiciels sur mesure</a></li>
                  <li><a className={`dropdown-item ${styles.dropdownItem} ${styles.dropdownItem0}`} href="#">Design de marque</a></li>
                </ul>
              </li>
              <li className="nav-item dropdown">
